...
class BaseVISEM(BaseSEM):
    ...
    @pyro_method
    def counterfactual_guide(self, x, thickness, intensity, label, counterfactual_type=-1):
    ...
    def reconstruct(self, x, thickness, intensity, label, num_particles: int = 1):
        ...
        for _ in range(num_particles):
            ...
            recon, *_ = pyro.poutine.condition(self.sample, data={'thickness': thickness, 'intensity': intensity, 'label': label, 'z': z})(x.shape[0])
            recons += [recon]
