...
if __name__ == '__main__':
    ...
    exp_parser.add_argument('--log-dir', '-ld', help='directory for tensorboard logs')
    ...
    logger = TensorBoardLogger(lightning_args.default_root_dir, name=f'{exp_args.log_dir}/{exp_args.model}')
