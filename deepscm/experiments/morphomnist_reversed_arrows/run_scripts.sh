python3 -m deepscm.experiments.morphomnist_reversed_arrows.trainer -e SVIExperiment -m ConditionalReversedVISEM --data_dir ./assets/data/morphomnist/intensity_causes_thickness --log-dir SVIExperimentReversedArrows --default_root_dir . --decoder_type fixed_var --gpus 0
